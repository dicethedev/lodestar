...
export function createLodestarMetrics(
  ...
  return {
    ...
    blsVerifier: {
      ...
      batchedSigCount: register.gauge({
      ...
      batchFlushDuration: register.histogram({
        name: "lodestar_bls_verifier_batch_flush_time_seconds",
        help: "End-to-end time for batch verification including retries",
        buckets: [0.01, 0.05, 0.1, 0.3, 0.5, 1, 2],
      }),
      sameMessageDuration: register.histogram({
        name: "lodestar_bls_verifier_same_message_time_seconds",
        help: "Time for same-message verification including retries",
        buckets: [0.001, 0.005, 0.01, 0.05, 0.1, 0.5],
      }),
